...
<body>
    ...
    <div class="container">
		...
		<br>아이디 비밀번호를 입력하신 후, 로그인 버튼을 클릭해 주세요.<br><br>
            <form action="sessionLoginCheckAd.jsp" method="post">
                	<input type="text" name="adID" placeholder="ID"><br>
       				<input type="password" name="adPW" placeholder="PW"><br>
                <input type="submit" value="관리자 로그인">
            </form>
            or<br>
            <input type="button" value="회원가입" onClick="location.href='signup_manager.jsp'"><br>
